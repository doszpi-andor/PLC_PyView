...
class Szalag3v1_View(SiloCanvas, ConveyorCanvas, SensorCanvas, IndicatorCanvas, WagonCanvas, AnalogCanvas):
    SILO_WIDTH = 100
    SILO_HEIGHT = 150
    CONVEYOR_WIDTH = 45
    WAGON_WIDTH = 200
    ...
    def __wagon_drawing(self):
        ...
        self.__wight_sensor_id = self.create_analog(x_position=self.WIGHT_SENSOR_X_POSITION,
                                                    ...
                                                    height=self.WAGON_HEIGHT, marks_position=(80, ),
