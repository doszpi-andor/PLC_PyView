...
from szalag_data.szalag6v0_data import Szalag6v0_Address


# noinspection PyPep8Naming,SpellCheckingInspection
class Szalag6v0_View(SiloCanvas, ConveyorCanvas, SensorCanvas, IndicatorCanvas):
    SILO_WIDTH = 100
    SILO_HEIGHT = 150
    ...
    def indicator_change_color(self, factory_color):
    ...
    def conveyor2_change_color(self, motor_color):
    ...
    def __buttons_drawing(self):
        self.create_square_indicator(self.INDICATOR_COLUMN1_X_POSITION,
                                     ...
                                     name='Start [%s]' % Szalag6v0_Address.START, color=self.start_color)
        self.create_square_indicator(self.INDICATOR_COLUMN1_X_POSITION,
                                     self.INDICATOR_ROW2_Y_POSITION,
                                     name='Stop [%s]' % Szalag6v0_Address.STOP, color=self.stop_color)

    def __indicators_drawing(self):
        self.create_circle_indicator(self.INDICATOR_COLUMN2_X_POSITION,
                                     self.INDICATOR_ROW1_Y_POSITION,
                                     name='Üzem [%s]' % Szalag6v0_Address.UZEM, color=self.factory_color)
    ...
    def __conveyors_drawing(self):
        self.create_conveyor(self.CONVEYOR1_X_POSITION,
                             ...
                             circle1_name='M2\n[%s]' % Szalag6v0_Address.M2, circle1_color=self.conveyor1_motor_color,
                             circle2_name='')
        self.create_conveyor(self.CONVEYOR2_X_POSITION,
                             self.CONVEYOR2_Y_POSITION,
                             length=self.CONVEYOR2_LENGTH, name='Szalag 2',
                             circle1_name='M3\n[%s]' % Szalag6v0_Address.M3, circle1_color=self.conveyor2_motor_color,
                             circle2_name='')
