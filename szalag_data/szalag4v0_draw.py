...
class Szalag4v0_View(SiloCanvas, ConveyorCanvas, SensorCanvas, IndicatorCanvas):
    SILO_WIDTH = 100
    SILO_HEIGHT = 150
    ...
    CONVEYOR1_LENGTH = 500

    CONVEYOR1_X_POSITION = 10

    DIRECTION1_INDICATOR_X_POSITION = CONVEYOR1_X_POSITION
    DIRECTION2_INDICATOR_X_POSITION = CONVEYOR1_X_POSITION + CONVEYOR1_LENGTH - 95

    INDICATOR_COLUMN1_X_POSITION = CONVEYOR1_X_POSITION
    INDICATOR_COLUMN2_X_POSITION = CONVEYOR1_X_POSITION + CONVEYOR1_LENGTH - 120
    ...
    FULL_WIDTH = CONVEYOR1_X_POSITION + CONVEYOR1_LENGTH + 10
    FULL_HEIGHT = CONVEYOR1_Y_POSITION + CONVEYOR_WIDTH
