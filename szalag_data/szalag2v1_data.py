...
class Szalag2v1_data(PLC_data):
    ...
    def read_data(self) -> None:
        ...
        self.__s1 = self.get_bit_in_page(Szalag2v1_Address.S1)
        self.__s2 = self.get_bit_in_page(Szalag2v1_Address.S2)
        self.__kp1 = self.get_bit_in_page(Szalag2v1_Address.KP1)
        self.__kp2 = self.get_bit_in_page(Szalag2v1_Address.KP2)
        self.__ks = self.get_bit_in_page(Szalag2v1_Address.KS)
        self.__start = self.get_bit_in_page(Szalag2v1_Address.START)
        self.__stop = self.get_bit_in_page(Szalag2v1_Address.STOP)

        self.__m1 = self.get_bit_in_page(Szalag2v1_Address.M1)
        self.__m2 = self.get_bit_in_page(Szalag2v1_Address.M2)
        self.__uzem = self.get_bit_in_page(Szalag2v1_Address.UZEM)
        self.__hiba = self.get_bit_in_page(Szalag2v1_Address.HIBA)
