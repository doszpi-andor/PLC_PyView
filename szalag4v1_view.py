...
from szalag_data.szalag4v1_data import Szalag4v1_data
from szalag_data.szalag4v1_draw import Szalag4v1_View
...
class App(PLC_View):
    ...
    def __init__(self, screenName=None, baseName=None, className='Tk', useTk=True, sync=False, use=None):
        ...
        self.title('Szalag 4v1')

        # noinspection SpellCheckingInspection
        self.name_label.config(text='Szalag 4v1')

        self.conveyors = Szalag4v1_View(self.process_frame)
        self.conveyors.pack()

        self.plc_data = Szalag4v1_data(self.ip_select.ip_address.get(), self.plc_rack, self.plc_slot)
